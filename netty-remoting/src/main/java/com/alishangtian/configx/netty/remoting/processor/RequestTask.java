...
public class RequestTask implements Runnable {
    ...
    private final XtimerCommand request;
    private boolean stopRun = false;

    public RequestTask(final Runnable runnable, final Channel channel, final XtimerCommand request) {
    ...
    public void returnResponse(int code, String remark) {
        final XtimerCommand response = XtimerCommand.builder().remark(remark).code(code).opaque(request.getOpaque()).build();
