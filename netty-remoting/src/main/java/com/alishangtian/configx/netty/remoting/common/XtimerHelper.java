package com.alishangtian.configx.netty.remoting.common;
...
public class XtimerHelper {
    ...
    public static XtimerCommand invokeSync(final String addr, final XtimerCommand request,
                                           final long timeoutMillis) throws InterruptedException, RemotingConnectException,
            RemotingSendRequestException, RemotingTimeoutException {
        long beginTime = System.currentTimeMillis();
        SocketAddress socketAddress = XtimerUtil.string2SocketAddress(addr);
        SocketChannel socketChannel = XtimerUtil.connect(socketAddress);
        if (socketChannel != null) {
            ...
            try {
                ...
                byteBufferBody.flip();
                return XtimerCommand.decode(byteBufferBody);
            } catch (IOException e) {
